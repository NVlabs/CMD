...
#
# Source:
#  https://github.com/sihyun-yu/PVDM/tree/main/losses/lossperceptual.py
#
...
import functools
from reconstruction.lpips import LPIPS
    ...
    def forward(self, inputs, reconstructions, optimizer_idx, global_step):
        ...
        if optimizer_idx == 0:
            if self.perceptual_weight > 0:
                p_loss = self.perceptual_weight * self.perceptual_loss(
            ...
            g_loss = -disc_factor * self.gan_weight * (
